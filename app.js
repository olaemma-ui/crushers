...
const Card = function({
    title, body, link, buttonText, imgUrl, buttonText2
}){
    return (`
...
const Progress = (value)=>{
    return (`
        <div class="progress-bar" style='max-width:${value}px'></div>
    `);
}
...
/// This function is a base function that handles all click functionalities
/// for the modals
